...
import { Cross1Icon, PlusIcon, DragHandleDots2Icon } from "@radix-ui/react-icons";
          ...
          <div className="space-y-2 mb-3">
            {carouselImages.map((img, index) => (
              <div
                ...
                className="flex items-center gap-3 rounded-lg border border-zinc-200 bg-white p-2 group"
              >
                {/* Reorder controls */}
